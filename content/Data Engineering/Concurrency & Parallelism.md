...
- enables a program to deal with multiple tasks even on a single CPU core; the core switches between tasks (i.e. [threads](https://en.wikipedia.org/wiki/Thread_(computing) "Thread (computing)")) without necessarily completing each one
